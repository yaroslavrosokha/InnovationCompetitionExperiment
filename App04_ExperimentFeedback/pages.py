...
class p04_example2(Page):
    """Description of the game: How to play and returns expected"""
    form_model = 'player'
    form_fields =['myTechEx2','otherTechEx2','myEarnEx2']
...
class p07_preTask(Page):
    ...
    def is_displayed(self):
        # print("================== p07_preTask()...is_displayed()...")
    ...
    def vars_for_template(self):
        ...
        temp['taskNumber'] = self.player.taskNumber+8 #CHANGE HERE WHEN CHANGING ORDER
        return temp
...
class p09_postTaskPart1(Page):
    ...
    def before_next_page(self):
        self.participant.vars['YesFeedTask'+str(self.player.taskNumber)+"Earn"]=self.player.myEarnN
...
class WaitForOtherBegin(WaitPage):
    template_name = 'App04_ExperimentFeedback/myWaitPage.html'
