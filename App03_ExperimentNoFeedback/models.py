...
doc = """
Innovation experiment: contest without feedback.
"""


class Constants(BaseConstants):
    name_in_url = 'App03_ExperimentNoFeedback'
...
class Player(BasePlayer):
    taskSelected = models.StringField()

    #Contest variables
    marketType = models.IntegerField(initial=3)
    ...
    winStatus = models.BooleanField(initial=True)
    ...
    myTechEx3 = models.StringField()
    myEarnEx3 = models.CurrencyField()
    otherTechEx3 = models.StringField()
